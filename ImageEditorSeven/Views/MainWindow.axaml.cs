...
using ImageEditorSeven.Models;
using ImageEditorSeven.ViewModels;
using ImageEditorSeven.ViewModels.Pages;
using System;
using System.Collections.Generic;
using System.Collections.ObjectModel;
using System.Linq;

namespace ImageEditorSeven.Views
{
    public partial class MainWindow : Window
    {
        ...
        private void PointerPressedReleasedDragShape(object? sender, PointerReleasedEventArgs e)
        {
            if (DataContext is MainWindowViewModel mainWindow)
            {
                ...
                if (mainWindow.FigureList[shapeNumber] is PolylineElement pol)
                {
                ...
                if (mainWindow.FigureListIndex > -1)
                {
                    ...
                    if (mainWindow.FigureList[mainWindow.FigureListIndex] is PolylineElement polylineEl)
                    {
